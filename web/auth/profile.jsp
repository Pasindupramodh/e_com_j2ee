                                        ...
                                        <div class="dash__pad-2">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    ...
                                                    <span class="dash__text"><%= customer.getFname()+" "+customer.getLname() %></span>
                                                </div>
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    <h2 class="dash__h2 u-s-m-b-8">E-mail</h2>

                                                    <span class="dash__text"><%= customer.getEmail() %></span>
                                                ...
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    ...
                                                    <span class="dash__text"><%= customer.getMobile() %></span>
                                                    <div class="dash__link dash__link--secondary">
                                                ...
                                                <div class="col-lg-4 u-s-m-b-30">
                                                    ...
                                                    <span class="dash__text"><%= customer.getGender()%></span>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12">
