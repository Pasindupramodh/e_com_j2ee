...
<html>
    ...
    <script>
        ...
        $(function () {
            ...
            $.ajax({
                type: 'PUT',
                url: '${ADMIN_BASE_URL}SystemUser?' + 'id=' + id + '&fname=' + fname + '&lname=' + lname + '&mobile=' + mobile + '&email=' + email + '&user_type=' + user_type + '',
        ...
        $(function () {
            ...
            $.ajax({
                type: 'PUT',
                url: '${ADMIN_BASE_URL}Login?' + 'id=' + id + '&username=' + username + '&password=' + password + '',
